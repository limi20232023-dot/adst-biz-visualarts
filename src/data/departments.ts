...
export const defaultTeachers: Teacher[] = [
  {
    ...
    bio: 'AI & Machine Learning Specialist. 12+ years in neural network research and quantum computing.',
  },
  {
    id: 't-va-1',
    ...
    bio: 'Digital Arts Director. Award-winning sculptor and multimedia installation artist.',
  },
  {
    id: 't-biz-1',
    ...
    name: 'Ms. Sarah Kim',
    department: 'business',
    bio: 'Entrepreneurship Lead. Former McKinsey consultant, serial startup advisor & mentor.',
  },
];